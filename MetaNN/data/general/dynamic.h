...
public:
    ...
    virtual const MetaNN::Shape<TDataCate>& Shape() const = 0;
...
public:
    ...
    const MetaNN::Shape<typename TInternalData::CategoryTag>& Shape() const override final
    {
...
public:
    ...
    bool operator== (const DynamicData& val) const
    {
        ...
        InternalType& val1 = *m_internal;
        InternalType& val2 = *(val.m_internal);
        return val1 == val2;
    }
