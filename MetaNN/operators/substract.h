...
struct OperSubstract
{
    ...
    static auto Eval(T1&& p_m1, T2&& p_m2)
    {
        ...
        return ResType(std::forward<T1>(p_m1), std::move(tmpMatrix));
    }
    ...
    static auto Eval(T1&& p_m1, T2&& p_m2)
    {
        ...
        auto tmpBatchMatrix = MakeDuplicate(p_m1.BatchNum(), std::forward<T2>(p_m2));
    ...
    static auto Eval(T1&& p_m1, T2&& p_m2)
    {
        ...
        auto tmpBatchMatrix = MakeDuplicate(p_m2.BatchNum(), std::forward<T1>(p_m1));
...
template <typename TP1, typename TP2,
          std::enable_if_t<OperSubstract::valid<TP1, TP2>>* = nullptr>
auto operator- (TP1&& p_m1, TP2&& p_m2)
{
    return OperSubstract::Eval(std::forward<TP1>(p_m1), std::forward<TP2>(p_m2));
}
}
