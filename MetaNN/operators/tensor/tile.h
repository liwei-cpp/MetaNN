...
namespace MetaNN
{
    namespace OperTile
    {
        ...
        {
            using type = DimBitArrayIs<ValueSequential::Contains<TDimArray, I>...>;
        };
        ...
        {
            using type = DimBitArrayIs<(I < TrueDimBound)...>;
        };
    ...
    auto Tile(TP&& oper, Shape<AimDim> aimShape)
    {
        ...
        using ResType = Operator<OpTags::Tile, OperandContainer<rawOp>,
